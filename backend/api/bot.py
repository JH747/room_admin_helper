...
def bot_yapen(driver, months):
    ...
    id_input.send_keys("idhere")
    pass_input.send_keys("passhere")
    login_button.click()
...
def get_one_month_yogei(driver, year, month):
    ...
    for day in days:
        ...
        date_obj = datetime(year=year, month=month, day=date_str)
